        ...
        <div className='displayModal'>
            <div className='modalBg modalBgArticle'>
                ...
                <form className='gridModalArticle' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input type='number' step=".01" className='qtyCmd' placeholder='Qté Cdée'{...register("qtyCmd", { required: true })}></input>
                    <input type='number' step=".01" className='tva' placeholder='TVA %'{...register("tva", { required: true })}></input>
